...
public class BarangKeluarView extends JInternalFrame {
    ...
    public BarangKeluarView() {
        super("Transaksi Barang Keluar", true, true, true, true);
        setSize(800, 500);
    ...
    private void initComponents() {
        ...
        formPanel.add(new JLabel("Jumlah Keluar:"));
        ...
        scrollPane.setBorder(BorderFactory.createTitledBorder("Keranjang Barang Keluar"));
    ...
    public JComboBox<Pelanggan> getCbPelanggan() { return cbPelanggan; }
